...
class ExecutionStatus(Enum):
    ...
    INE = 6  # Internal error has occurred, prompt user to try again! ( )


class TestCase:
    input_data = None
    output_data = None
    is_hidden_test_case = False  # some test cases can be hidden
    ...
    def execute(self):
        ...
        if self.language is not None:
            ...
            if self.language == Language.PYTHON:
                ...
                if self.hasExecuted and self.exec_status is not ExecutionStatus.TLE:
